...
import "./main/AbstractView.js";
import "./components/BootstrapDialogView";
import "./main/ErrorsHandler";
import "./components/Footer";
import "./main/i18nManager";
import "./components/Messages";
import "./components/Navigation";
import "./main/ProcessConfiguration";
import "./main/Router";
import "./main/SessionManager";
import "./main/SpinnerManager";
import "./SiteConfigurator";
